...
| :--------    | :---------------- | :------------ | :---------------------- | :------------------ |  :----------------------------- |
| backprop     | c,js,matlab       |  S,M,L        | yes                     | chrome,firefox,matlab-vm,native,node,safari | yes                            |
| bfs          | c                 |  S,M,L (L only for C, not enough memory on JS)        | yes                     | chrome,firefox,native,node,safari              | no                             |
| crc          |                   |               | no                      | no                             |
| fft          |                   |               | no                      | no                             |
| hmm          |                   |               | no                      | no                             |
| lavamd       |                   |               | no                      | no                             |
